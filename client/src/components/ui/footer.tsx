...
export const Footer = () => {
  return (
    <>
      <footer className="bg-[#071A45] text-white">
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-3xl">
                <p className="font-bold">XYZ</p> <p>Industris</p>
              </div>
              ...
              <Button className="bg-transparent border-white border-1 rounded-full">
                Explore <ArrowRight className="text-[10px]" />
              </Button>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              ...
              <div>
                <p className="font-medium text-gray-100">Subscribe Us</p>
                <Form />
              </div>
            </div>
          </div>
